<x-layout-admin>
    <form action="{{route('productsale.store')}}" method="post">
        @csrf
        <div class="content-wrapper p-5 bg-gray-50 min-h-screen">
            <div class="bg-white shadow-md rounded-lg p-4 mb-4">
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-black-600">Thêm giá khuyến mãi</h2>
                ...
                <div class="flex gap-6">
                    <div class="basis-9/12">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('price_sale')}}" type="number" class="w-full border border-gray-300 rounded-lg p-2" placeholder="Nhập giá khuyến mãi" name="price_sale" id="price_sale">
                        ...
                        <div class="flex justify-between gap-5">
                            <div class="mb-3">
                                ...
                                <input value="{{old('date_begin')}}" type="date" class="w-full border border-gray-300 rounded-lg p-2" name="date_begin" id="date_begin">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{old('date_end')}}" type="date" class="w-full border border-gray-300 rounded-lg p-2" name="date_end" id="date_end">
