    ...
    <div class="content-wrapper bg-white">
        <div class="border border-blue-100 mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                <div class="">
                    <h2 class="text-xl font-bold text-blue-300">Danh sách chủ đề</h2>
                </div>
                <div class="text-right">
                    <a href="{{route('topic.create')}}" class="bg-green-300 px-2 py-2 rounded-xl mx-1 text-white">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                        Thêm mới
                    </a>
                    <a href="{{route('topic.trash')}}" class="bg-red-300 px-2 py-2 rounded-xl mx-1 text-white">
                ...
                <tbody>
                    ...
                    <tr>  
                        ...
                        <td class="border border-gray-300 p-2 text-center space-x-2">
                            <a href="{{ route('topic.status', ['topic' => $item->id]) }}" class="inline-block">
                                @if ($item->status == 1)
                            ...
                            <a href="{{ route('topic.edit', ['topic' => $item->id]) }}" class="inline-block">
