        ...
        <div class="border border-blue-100 mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <a href="{{route('brand.create')}}" class="bg-green-300 px-2 py-2 rounded-xl mx-1 text-white">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                        Thêm mới
                    </a>
                    <a href="{{route('brand.trash')}}" class="bg-red-300 px-2 py-2 rounded-xl mx-1 text-white">
            ...
            <table class="border-collapse border-gray-400 w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border border-gray-300 p-2">Mô Tả Thương Hiệu</th>
                ...
                <tbody>
                    ...
                    <tr>  
                        ...
                        <td class="border border-gray-300 p-2 text-center space-x-2">
                            <a href="{{ route('brand.status', ['brand' => $item->id]) }}" class="inline-block">
                                @if ($item->status == 1)
                            ...
                            <a href="{{ route('brand.edit', ['brand' => $item->id]) }}" class="inline-block">
