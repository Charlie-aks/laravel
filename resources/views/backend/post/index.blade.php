    ...
    <div class="content-wrapper bg-white">
        <div class="border border-blue-100 mb-3 rounded-lg p-2">
            <div class="flex items-center justify-between">
                <div class="">
                    <h2 class="text-xl font-bold text-blue-300">Danh sách bài viết</h2>
                </div>
                <div class="text-right">
                    <a href="{{route('post.create')}}" class="bg-green-300 px-2 py-2 rounded-xl mx-1 text-white">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                        Thêm mới
                    </a>
                    <a href="{{route('post.trash')}}" class="bg-red-300 px-2 py-2 rounded-xl mx-1 text-white">
            ...
            <table class="border-collapse border-gray-400 w-full">
                ...
                <tbody>
                    ...
                    <tr>  
                        ...
                        <td class="border border-gray-300 p-2">{{ $item->thumbnail }}</td>
