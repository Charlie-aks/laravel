...
<head>
    ...
    <title>@yield('title') - Banner Management</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-64 bg-gray-800 text-white">
            ...
            <nav class="mt-4">
                ...
                <a href="{{ route('admin.banner.index') }}" class="block py-2 px-4 hover:bg-gray-700 {{ request()->routeIs('admin.banner.*') ? 'bg-gray-700' : '' }}">
